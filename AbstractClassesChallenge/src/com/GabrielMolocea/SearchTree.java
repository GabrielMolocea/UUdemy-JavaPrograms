...
public class SearchTree implements NodeList {
    ...
    public boolean addItem(ListItem newItem) {
        if (this.root == null){
            //The list in empty and this item become the head
            this.root = newItem;
            return true;
        }
    ...
    public boolean removeItem(ListItem item) {
        ...
        while (currentItem != null){
            int comparison =  (currentItem.compereTo(item));
            if (comparison < 0 ){
                ...
                performRemobel(currentItem,parentItem);
                return true;
            }
        }
        return false;
    ...
    private void performRemobel(ListItem item, ListItem parent) {
